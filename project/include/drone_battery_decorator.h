/**
 *@file drone_battery_decorator.h
 */
#ifndef DRONE_BATTERY_DECORATOR_H_
#define DRONE_BATTERY_DECORATOR_H_
...
class DroneBatteryDecorator : public Drone {
public:
  /**
   * @brief Constructor: sets up Drone by instantiating all of its values.
   */
  DroneBatteryDecorator(Drone *drone) ;
...
#endif    // DRONE_BATTERY_DECORATOR_H_