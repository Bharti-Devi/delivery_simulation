...
class ParabolicPathfinderTest : public ::testing::Test {
    protected:
        virtual void SetUp() {
            pathfinder = new ParabolicPathfinder();
            start1.push_back(0);
            start1.push_back(0);
            start1.push_back(0);
        ...
        ParabolicPathfinder* pathfinder;
};

TEST_F(ParabolicPathfinderTest, GetPath){
    //Test first position
