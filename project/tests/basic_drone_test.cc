...
TEST_F(BasicDroneTest, ConstructorTest){
  ...
  //GetName
  EXPECT_EQ(entity1->GetName(),"drone");
  EXPECT_EQ(entity2->GetName(),"drone");
  EXPECT_EQ(entity3->GetName(),"drone");
  //IsDynamic
  EXPECT_EQ(entity1->IsDynamic(), true);
  EXPECT_EQ(entity2->IsDynamic(), true);
  EXPECT_EQ(entity3->IsDynamic(), true);
  //GetVersion
  EXPECT_EQ(entity1->GetVersion(), 0);
  EXPECT_EQ(entity2->GetVersion(), 0);
  EXPECT_EQ(entity3->GetVersion(), 0);
  //IsScheduled
