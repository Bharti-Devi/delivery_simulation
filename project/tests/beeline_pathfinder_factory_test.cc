...
class BeelinePathfinderFactoryTest : public ::testing::Test {
    protected:
        virtual void SetUp() {
            factory = new BeelinePathfinderFactory();
            pathfinder = factory->CreatePathfinder("beeline");
            start1.push_back(0);
            start1.push_back(0);
            start1.push_back(0);
        ...
        BeelinePathfinderFactory* factory;
        Pathfinder* pathfinder;
};

TEST_F(BeelinePathfinderFactoryTest, GetPath){
    //Test 0th position
